...
import com.example.phonebooktommy.repository.services.addContactService
...
class ContactClient {
    companion object {
        val SERVICE_ADD: addContactService by lazy {
            ...
            val retrofit = Retrofit
                ...
                .build()
            retrofit.create(addContactService::class.java)
        }
    }
}